...
export function OrdersFilters(): JSX.Element{
  return(
    <Card className="m-1 mb-4 flex flex-col p-4 gap-4">
      ...
      <Input className="mb-2"  labelPlacement="outside" label="Billing full name" placeholder="John Doe"/>
      <Input className="mb-2" labelPlacement="outside" label="Order number" placeholder="11321"/>
